...
def get_args_parser(subparsers: argparse.ArgumentParser):
    ...
    subparsers.add_argument('--head_mode', type=str,
                            ...
                            default='concat')
    subparsers.add_argument('--text_template', type=str, default='a photo of a person feeling {}.')
    ...
    subparsers.add_argument('--base_classes', default=5, type=int, help='number of base classes')
