...
def get_args_parser(subparsers: argparse.ArgumentParser):
    ...
    subparsers.add_argument('--batch_size', default=128, type=int, help='Batch size per device')
    ...
    subparsers.add_argument('--num_prompts', type=int, default=20)
    subparsers.add_argument('--detach', action='store_true', help='Detach the cls token befor computing similarity')
    subparsers.add_argument('--num_selectors', type=int, default=20)
    ...
    subparsers.add_argument('--project', default='fluffy-multi')
    ...
    subparsers.add_argument('--dataset', default='Split-COCO', type=str, help='dataset name')
    ...
    subparsers.add_argument('--base_classes', default=10, type=int, help='number of base classes')
