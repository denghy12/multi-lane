...
def get_args_parser(subparsers: argparse.ArgumentParser):
    ...
    subparsers.add_argument('--batch_size', default=1024, type=int, help='Batch size per device')
    ...
    subparsers.add_argument('--num_prompt_layers', type=int, default=12)
    ...
    subparsers.add_argument('--base_classes', default=20, type=int, help='number of base classes')
